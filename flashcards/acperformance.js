...
export const acperformance = [
	{ front: "Define: V<sub>REF</sub>", back: "Reference Speed, Final Approach/Landing Speed" },
	{ front: "Define: V<sub>MCA</sub>", back: "Minimum Controllable Airborne Speed<br>(with 1 engine inoperative)" },
	{ front: "Define: V<sub>MCG</sub>", back: "Nosewheel Steering (rudder control is ineffective)<br>Minimum Controllable Ground Speed" },
	{ front: "Define: V<sub>2</sub>", back: "Takeoff Safety Speed<br>(Aircraft can safely remain airborne after leaving ground effect)" },
	{ front: "Define: V<sub>SO</sub>", back: "Landing Configuration Stall Speed<br>(Dirty - Flaps/Slats and Landing Gear Extended)" },
	{ front: "Define: V<sub>LOF</sub>", back: "Liftoff Speed" },
	{ front: "Define: V<sub>1</sub>", back: "Takeoff Decision Speed" },
	{ front: "Define: V<sub>S</sub>", back: "Stall Speed<br>(Clean - Flaps/Slats and Landing Gear Tucked in)" },
	{ front: "Define: V<sub>FTO</sub>", back: "Final Takeoff Speed" },
	{ front: "Define: V<sub>MU</sub>", back: "Minimum Unstick Speed" },
	{ front: "Define: V<sub>R</sub>", back: "Rotation Speed<br>(Pitching the nose up)" },
	{ front: "Define: V<sub>A</sub>", back: "In Air Maneuvering Speed<br>(Maximum speed the AC can be controlled with the rudder in the air)<br>Never go full 'rudder'" },
