...
export const envoytest2024 = [
	...
	{ front : `You dispatched a flight not requiring an alternate. It is now airborne and subsequently the weather forecast changes while en-route, now the destination airport is forecasted to be alternate required. You don't have enough fuel to add an alternate. Are you required to add an alternate, so the flight can continue?`, back: `NO` },
	{ front : `Embedded thunderstorms, surface winds greater than 50kts, hail at surface greater than/equal to ¾, tornadoes, a line of thunderstorms is an advisory known as?`, back: `A convective SIGMET` },
	...
	{ front : `What 3 things is a dispatcher solely responsible for in accordance with 14CFR 121.533?`, back: `<ul><li><b>Monitoring</b> the progress of the flight</li><li>Issuing information to the PIC for the <b>Safety</b> of the flight</li><li><b>Canceling or Re-dispatching</b> a flight, if the DX or PIC determine the flight cannot operate or continue to operate safely as planned</li></ul>` },
	...
	{ front : `True or False: For airplanes having a seating capacity of more than 50 but less than 101 passengers, are 3 flight attendants are required?`, back: `FALSE` },
	...
	{ front : `True or False: The equipment requirements for an aircraft to operate in RVSM airspace is 2 independent altimeters, 1 altitude reporting system, 2 altitude alert systems, 1 altitude control system`, back: `FALSE<br>Think of 2RAC` },
